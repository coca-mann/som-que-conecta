      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
          <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 class="text-3xl font-bold text-gray-900 mb-2">Agendamentos</h1>
              <p class="text-gray-600">Gerencie os agendamentos dos seus instrumentos</p>
            </div>
        ...
        <!-- Calendar View -->
        <div v-if="currentView === 'calendar'" class="bg-white rounded-lg shadow-sm p-6">
          ...
          <div class="grid grid-cols-7 gap-px bg-gray-200 rounded-lg overflow-hidden">
            ...
            >
              <div class="flex items-center justify-between mb-2">
                ...
                <div v-if="getBookingsForDay(day.date).length > 0" class="flex space-x-1">
              ...
              <div class="space-y-1">
                ...
                >
                  <div class="font-medium truncate">{{ booking.instrument.name }}</div>
                  <div class="truncate">{{ formatTime(booking.startTime) }}</div>
                </div>
        ...
        <div v-else class="bg-white rounded-lg shadow-sm overflow-hidden">
          <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-900">Lista de Agendamentos</h2>
          </div>
        ...
        <div v-if="selectedBooking" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div class="bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div class="flex items-center justify-between p-6 border-b border-gray-200">
              <h3 class="text-xl font-semibold text-gray-900">Detalhes do Agendamento</h3>
              <button
            ...
            <div class="p-6 space-y-6">
              ...
              <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div class="flex items-center space-x-3">
                    ...
                    />
                    <div>
                      <div class="font-medium text-gray-900">{{ selectedBooking.instrument.name }}</div>
                      <div class="text-sm text-gray-500">{{ selectedBooking.instrument.brand }}</div>
                      <div class="text-sm text-gray-500">{{ selectedBooking.instrument.type }}</div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div class="flex items-center space-x-3">
                    ...
                    />
                    <div>
                      <div class="font-medium text-gray-900">{{ selectedBooking.client.name }}</div>
                      <div class="text-sm text-gray-500">{{ selectedBooking.client.email }}</div>
                      <div class="text-sm text-gray-500">{{ selectedBooking.client.phone }}</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="grid md:grid-cols-3 gap-4">
                ...
                <div>
                  <h4 class="text-sm font-medium text-gray-500 mb-2">Horário</h4>
                  <div class="flex items-center space-x-2">
              ...
              <div v-if="selectedBooking.notes">
                ...
                <p class="text-gray-900 bg-gray-50 p-3 rounded-lg">{{ selectedBooking.notes }}</p>
              </div>
  
              <!-- Rejection Reason -->
              <div v-if="selectedBooking.status === 'rejected' && selectedBooking.rejectionReason">
                <h4 class="text-sm font-medium text-gray-500 mb-2">Motivo da Rejeição</h4>
              ...
              <!-- Rejection Form -->
              <div v-if="showRejectionForm" class="border-t border-gray-200 pt-6">
                <h4 class="text-sm font-medium text-gray-500 mb-3">Motivo da Rejeição</h4>
                <textarea
