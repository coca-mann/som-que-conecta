...
CKEDITOR_5_CONFIGS = {
    ...
    'extends': {
        ...
        'table': {
            'contentToolbar': [
                'tableColumn', 'tableRow', 'mergeTableCells', 'tableProperties', 'tableCellProperties'], 'tableProperties': {
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",
    "http://localhost:8080",   # A origem do seu frontend Vue, conforme o erro
    "http://127.0.0.1:8080"
]
