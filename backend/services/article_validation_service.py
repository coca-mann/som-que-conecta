...
class ArticleValidationService:
    ...
    def validate_article(article_content: str) -> Dict[str, Any]:
        ...
        4. Não tiver conteúdo musical relevante
        5. For muito curto ou superficial
        6. Contiver spam ou propaganda

        Aprove o artigo se:
        1. Tiver conteúdo musical relevante e educativo
        2. For bem estruturado e coeso
        3. Tiver profundidade e valor para a comunidade
